    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '学校', width: 100, field: 'shopname', sortable: true},
                {title: '到店日期', width: 100, field: 'todate', sortable: true},
                {title: '到店时间', width: 100, field: 'shijian', sortable: true},
                {title: '人数', width: 100, field: 'renshu', sortable: true},
                {title: '预定人', width: 100, field: 'xingming', sortable: true},
