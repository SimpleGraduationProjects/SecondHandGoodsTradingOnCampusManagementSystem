...
<head id="Head1">
    ...
    <script type="text/javascript">
            ...
            $('#grid1').datagrid({
                ...
                columns: [
                    [
                        ...
                        {title:'余额',width:100,field:'money'}
        ...
        function saveCharge(){
            var money = $("#money").val();
            $.post("<%=__APP__%>/User!saveCharge", {id: focusobj.id,money:money}, function () {
...
<div id="managerDialog2" class="easyui-dialog" title="用户充值" style="width:500px;height:290px;" toolbar="#dlg-toolbar"
     buttons="#dlg-buttons3" resizable="true" modal="true" closed='true'>

        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="10%" align="right"><label>金额：</label></th>
                <td width="30%">
                    <input id="money" name="money" class="easyui-numberbox"
                           style="width:300px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,32]"/></td>
            </tr>

        </table>

    <div id="dlg-buttons3">
        <a href="#" class="easyui-linkbutton" onclick="saveCharge();">确定</a>
        <a href="#" class="easyui-linkbutton" onclick="cancel();">取消</a>
    </div>
</div>
