...
public class VipServiceImp implements VipService {
	...
	public void delete(Integer uuid) {
		sessionFactory.getCurrentSession().delete(
				sessionFactory.getCurrentSession().load(Vip.class, uuid));
	}

	@Transactional(propagation = Propagation.NOT_SUPPORTED)
	public Vip find(String uuid) {
		return (Vip) sessionFactory.getCurrentSession().get(Vip.class, uuid);
	...
	public Vip find(Vip model) {
		try {
			List<Vip> list = getHibernateTemplate().findByExample(model);
			if (list.size() > 0) {
				return list.get(0);
			}
	...
	public List<Vip> list() {
		return sessionFactory.getCurrentSession().createQuery("from Vip")
				.list();
	}
	...
	public Page findByPage(Page page, Map paramsMap) {
		...
		sb.append("from Vip u where 1=1");
		if (paramsMap.get("username") != null&& !"".equals(paramsMap.get("username"))) {
			sb.append(" and u.username like '%" + paramsMap.get("username")+ "%'");
		}
